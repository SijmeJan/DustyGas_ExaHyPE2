#ifndef __DustyGasSolver_CLASS_HEADER__
#define __DustyGasSolver_CLASS_HEADER__
...
class DustyGas::DustyGasSolver : public DustyGas::AbstractDustyGasSolver {
  private:
    /**
     * Log device
     */
...
#endif // __DustyGasSolver_CLASS_HEADER__
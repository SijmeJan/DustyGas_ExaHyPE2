...
// =============================---==============
#ifndef __DustyGasSolver_Variables_CLASS_HEADER__
#define __DustyGasSolver_Variables_CLASS_HEADER__
 ...
 * specification file
 **/
struct DustyGas::AbstractDustyGasSolver::VariableMetrics {
 ...
 **/
class DustyGas::AbstractDustyGasSolver::VariableShortcuts : public DustyGas::AbstractDustyGasSolver::VariableMetrics {
public:
  /// positions of fields inside the unknown vector (solution vector) Q
  const int _Q[numDistinctVariables + 1] = { 0,1 };
 ...
 **/
class DustyGas::AbstractDustyGasSolver::VariableMultiplicities : public DustyGas::AbstractDustyGasSolver::VariableMetrics {
public:
  /// positions of fields inside the unknown vector (solution vector) Q
 
  const int _Q[numDistinctVariables] = { 1,3 };
 ...
 *
 **/
class DustyGas::AbstractDustyGasSolver::VariableNames : public DustyGas::AbstractDustyGasSolver::VariableMetrics {
public:
  char const *_Q[numDistinctVariables + 1] = { "rho","j" };
 ...
 * 
 *    void somewhere() {
 *       using namespace DustyGas::DustyGasSolver_Variables::shortcuts;
 *       Q[foo] = 17;
 *    }
 *
 * instead of
 * 
 *    void somewhere() {
 *       DustyGas::AbstractDustyGasSolver::VariableNames q;
 *       Q[q.foo] = 17;
 *    }
 *
 **/
namespace DustyGas {
  namespace DustyGasSolver_Variables {
    namespace shortcuts {
      constexpr int rho = 0;
      constexpr int j = 1;
    } // namespace shortcuts
  ...
  } // end of namespace DustyGas::DustyGasSolver_Variables 
} // end of namespace DustyGas
...
class DustyGas::AbstractDustyGasSolver::ReadOnlyVariables : public DustyGas::AbstractDustyGasSolver::VariableMetrics {
  private:
...
class DustyGas::AbstractDustyGasSolver::Variables : public DustyGas::AbstractDustyGasSolver::VariableMetrics{
  private:
    double* const _Q;
  public:
    static constexpr int SizeVariables  = 4;
...
class DustyGas::AbstractDustyGasSolver::Fluxes : public DustyGas::AbstractDustyGasSolver::VariableMetrics {
  private:
    double** const _F;
  public:
...
// Global Observables
//
class DustyGas::AbstractDustyGasSolver::ReadOnlyGlobalObservables {
  private:
...
class DustyGas::AbstractDustyGasSolver::GlobalObservables {
  private:
